...
train_paths = {'AD':['texts/multiple_sites_half/NYU/AD_4'],'TD':['texts/multiple_sites_half/NYU/TD_4']};
test_paths = {'AD':['texts/multiple_sites_half/OHSU/AD_4','texts/multiple_sites_half/PKU/AD_4'],
            'TD':['texts/multiple_sites_half/OHSU/TD_4','texts/multiple_sites_half/PKU/TD_4']};
#test_paths = {'AD':['texts/multiple_sites_half/PKU/AD_4'],
#            'TD':['texts/multiple_sites_half/PKU/TD_4']};
